...
from entity.wiki.kor_model.config import config
from entity.wiki.kor_model.data_embed_model import word2vec, data_utils
from entity.wiki.kor_model.data_embed_model.data_utils import CoNLLDataset
from entity.wiki.kor_model.ner_model.lstmcrf_model import NERModel
