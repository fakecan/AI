...
def build_network(num_gpu=1, input_shape=None):
    ...
    #합성곱 블록1
    conv1 = Conv2D(4, kernel_size=(3,3), actvation='relu', name='conv_1')(inputs)
    batch1 = BatchNormalization(name='batch_norm_1')(conv1)
    pool1 = MaxPooling2D(pool_size=(2,2), name='pool_1')(batch1)

    #합성곱 블록2
    conv2 = Conv2D(32, kernel_size=(3,3), actvation='relu', name='conv_1')(pool1)
...
model = build_network(num_gpu=1, input_shape=(IMG_HEGHT, IMG_WIDTH, CHNNELS))
