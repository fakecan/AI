...
encoded = Conv2D(3, kernel_size=(1, 1), padding='same',
                 activation='relu')(input_img)

# encoded = Conv2D(9, (3,3), padding='same', activation='relu')(encoded)
...
decoded = Conv2D(3, (1, 1), padding='same', activation='sigmoid')(encoded)
...
# 인코딩된 입력을 위한 플레이스 홀더
encoded_input = Input(shape=(32, 32, 3)) # 디코딩의 인풋레이어로 시작
