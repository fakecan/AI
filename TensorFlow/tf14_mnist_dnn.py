...
h2 = hiddenLayer(h1.Y2, 16, 8)
h3 = hiddenLayer(h2.Y2, 8, 64)
h4 = hiddenLayer(h3.Y2, 64, 12)
h5 = hiddenLayer(h4.Y2, 12, 2)
h6 = hiddenLayer(h5.Y2, 2, 8)
h7 = hiddenLayer(h6.Y2, 8, 16)
h8 = hiddenLayer(h7.Y2, 16, 8)
h9 = hiddenLayer(h8.Y2, 8, 4)
